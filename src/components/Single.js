...
class Main extends React.Component{
    ...
    toggleSlider() {
        this.setState({slider_in : !this.state.slider_in})
    }
        ...
        return (
            <div>
              <div className="">
                ...
                className= { this.state.slider_in ?
                        'lyt-sidebar fixed ':
                        'lyt-sidebar fixed active'
                    }
                ...
                <div className="" id={this.state.slider_in ? null: "my_content" }>
                  {/* main content  */}
                    ...
                    <div className="grid ">
                      <div className="column w-18@md">
                        <p>
                          ...
                          started when learning something new. Let’s get started with
                          GitHub!
                        </p>
                        ...
                        <p>
                          ...
                          branches, commits, and Pull Requests. You’ll create your own
                          Hello World repository and learn GitHub’s Pull Request
                        ...
                        <p>
                          ...
                          Internet access. You don’t need to know how to code, use the
                          command line, or install Git (the version control software
                          GitHub is built on).
                        </p>
                        ...
                        <p>
                          A <strong>repository</strong> is usually used to organize a
                          single project. Repositories can contain folders and files,
                          images, videos, spreadsheets, and data sets – anything your
                          project needs. We recommend including a README, or a file with
                          information about your project. GitHub makes it easy to add
                          one at the same time you create your new repository. It also
                          offers other common options such as a license file.
                        </p>
                        <p>
                          Your hello-world repository can be a place where you store
                          ideas, resources, or even share and discuss things with
                          others.
                        </p>
                        ...
                        <p>
                          By completing this tutorial, you’ve learned to create a
                          project and make a pull request on GitHub!
                        </p>
                        ...
                        <p>
                          To learn more about the power of Pull Requests, we recommend
                          reading the GitHub flow Guide. You might also visit GitHub
                          Explore and get involved in an Open Source project.
                        </p>
        
                        <p id="quote_para">
                          <strong>Tip:</strong> Check out our other Guides, YouTube
                          Channel and On-Demand Training for more on how to get started
                          with GitHub.
                        </p>
