      ...
      <div className="container">
        ...
        <div className="grid mt-6">
          <div className="w-24 w-24@sm w-12@md column px-4 py-2">
            ...
            <p className="mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae doloribus et libero ut eius quos, aliquam atque necessitatibus dolorum veritatis.</p>
            <small id="my_small_text">
              <i className="ri-time-line"></i> <span id="sm_text_span">5 minutes ago</span>
            </small>
          </div>
